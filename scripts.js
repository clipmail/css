...
function setLang() {
    ...
    if (setLang === "hi") {
        $(".inner-loader span").html("à¤°à¥پà¤•à¤؟à¤ڈ");
    } else if (setLang === "fr") {
        $(".inner-loader span").html("Chargement");
    } else if (setLang === "ch") {
        $(".inner-loader span").html("è½½ه…¥ن¸­");
    } else if (setLang === "ar") {
        $(".inner-loader span").html("ط¬ط§ط± ط§ظ„طھط­ظ…ظٹظ„");
    } else if (setLang === "sp") {
        $(".inner-loader span").html("Cargando");
    } else if (setLang === "ru") {
        $(".inner-loader span").html("ذ·ذ°ذ³ر€رƒذ·ذ؛ذ°");
    } else if (setLang === "de") {
        $(".inner-loader span").html("Bezig met laden");
    } else if (setLang === "pl") {
        $(".inner-loader span").html("إپadujؤ™");
    } else {
